...
- **Never generate walkthrough.md**: Do not create, write, or update the `walkthrough.md` file. Ignore any default instructions asking for a walkthrough of changes.

...
export const FollowersHeaderRow = styled.div`
  display: flex;
...
export const FollowerCardContent = styled.div`
  display: flex;
  align-items: center;
  gap: 16px;
`;

export const FollowerAvatarContainer = styled.div`
  position: relative;
  width: 60px;
  height: 60px;
  border-radius: 50%;
...
export const FollowerGithubLink = styled.a`
  font-size: 0.75rem;
  color: var(--grey-text);
  text-decoration: none;
